...
const defaultConfig: EvalRunConfig = { caseCount: 6, language: 'pt-BR', outputLanguage: 'pt-BR', modes: [...MODES], difficulty: 'hard', categories: ['normal', 'incomplete', 'ambiguous', 'contradictory', 'adversarial'], insightModel: 'openai/gpt-5.6-sol-pro', supervisorModel: 'anthropic/claude-sonnet-4.6', systemPrompt: '', supervisorPrompt: '' };
