...
const COPY: Record<Language, Record<string, string>> = {
  en: {
    ...
    overallAssessment: 'Overall assessment', signalsAndCompetencies: 'Signals and competencies', evaluatedAnswers: 'Evaluated answers', preparationPlan: 'Preparation plan', learnerAssessment: 'Speaker assessment', patternsAndCorrections: 'Patterns and corrections', progressGroup: 'Observed progress', nextLessonGroup: 'Suggested improvement plan', decisionsAndActions: 'Decisions and actions', risksAndPending: 'Risks and pending items', contextAndParticipants: 'Context and participants', metricsAndImplications: 'Metrics and implications',
    interview: 'Interview analysis', languageClass: 'Communication and language analysis', meeting: 'Meeting analysis', lens: 'Analysis lens',
    ...
    lessonContext: 'Communication context', objective: 'Identified objective', targetLanguage: 'Target language', learnerSpeakers: 'Assessed speakers', teacherSpeakers: 'Facilitators', topics: 'Topics', learnerProfiles: 'Assessed speakers', cefr: 'CEFR', skills: 'Skills', languagePatterns: 'Language patterns', corrections: 'Priority corrections', lessonProgress: 'Observed progress', teacherPlan: 'Suggested improvement plan', homework: 'Suggested practice',
  ...
  pt: {
    ...
    overallAssessment: 'Avaliação geral', signalsAndCompetencies: 'Sinais e competências', evaluatedAnswers: 'Respostas avaliadas', preparationPlan: 'Plano de preparação', learnerAssessment: 'Avaliação do speaker', patternsAndCorrections: 'Padrões e correções', progressGroup: 'Progresso encontrado', nextLessonGroup: 'Plano sugerido de melhoria', decisionsAndActions: 'Decisões e ações', risksAndPending: 'Riscos e pendências', contextAndParticipants: 'Contexto e participantes', metricsAndImplications: 'Métricas e implicações',
    interview: 'Análise de entrevista', languageClass: 'Análise de comunicação e idioma', meeting: 'Análise da reunião', lens: 'Perspectiva de análise',
    ...
    lessonContext: 'Contexto de comunicação', objective: 'Objetivo identificado', targetLanguage: 'Idioma-alvo', learnerSpeakers: 'Speakers avaliados', teacherSpeakers: 'Facilitadores', topics: 'Tópicos', learnerProfiles: 'Speakers avaliados', cefr: 'CEFR', skills: 'Habilidades', languagePatterns: 'Padrões de linguagem', corrections: 'Correções prioritárias', lessonProgress: 'Progresso encontrado', teacherPlan: 'Plano sugerido de melhoria', homework: 'Prática sugerida',
  ...
  es: {
    ...
    overallAssessment: 'Evaluación general', signalsAndCompetencies: 'Señales y competencias', evaluatedAnswers: 'Respuestas evaluadas', preparationPlan: 'Plan de preparación', learnerAssessment: 'Evaluación del hablante', patternsAndCorrections: 'Patrones y correcciones', progressGroup: 'Progreso observado', nextLessonGroup: 'Plan de mejora sugerido', decisionsAndActions: 'Decisiones y acciones', risksAndPending: 'Riesgos y pendientes', contextAndParticipants: 'Contexto y participantes', metricsAndImplications: 'Métricas e implicaciones',
    interview: 'Análisis de entrevista', languageClass: 'Análisis de comunicación e idioma', meeting: 'Análisis de la reunión', lens: 'Perspectiva de análisis',
    ...
    lessonContext: 'Contexto de comunicación', objective: 'Objetivo identificado', targetLanguage: 'Idioma objetivo', learnerSpeakers: 'Hablantes evaluados', teacherSpeakers: 'Facilitadores', topics: 'Temas', learnerProfiles: 'Hablantes evaluados', cefr: 'CEFR', skills: 'Habilidades', languagePatterns: 'Patrones de lenguaje', corrections: 'Correcciones prioritarias', lessonProgress: 'Progreso observado', teacherPlan: 'Plan de mejora sugerido', homework: 'Práctica sugerida',
...
const FIELD_COPY: Record<Language, Record<string, string>> = {
  en: { confidence: 'Confidence', evidenceSufficiency: 'Evidence sufficiency', overallAssessment: 'Overall assessment', grammar: 'Grammar', vocabulary: 'Vocabulary', fluency: 'Fluency', coherence: 'Coherence', interaction: 'Interaction', intelligibility: 'Intelligibility', score: 'Score', observation: 'Observation', whyItMatters: 'Why it matters', pattern: 'Pattern', communicationImpact: 'Communication impact', nextStep: 'Next step', participation: 'Participation', share: 'Share', interactionPattern: 'Interaction pattern', teacherFeedback: 'Improvement feedback', category: 'Category', frequency: 'Frequency', impact: 'Impact', original: 'Original', corrected: 'Corrected', explanation: 'Explanation', rule: 'Rule', recurrence: 'Recurrence', priority: 'Priority', successfulUse: 'Successful use', skill: 'Skill', whySuccessful: 'Why it worked', selfCorrections: 'Self-corrections', missedOpportunities: 'Missed opportunities', opportunity: 'Opportunity', coachPrompt: 'Practice suggestion', reinforce: 'Areas to consolidate', reason: 'Reason', nextLessonFocus: 'Improvement focus', why: 'Why', activities: 'Activities', successMetric: 'Success metric', durationMinutes: 'Duration in minutes', basedOn: 'Based on', participants: 'Participants', outcome: 'Outcome', whatChanged: 'What changed', needsDecision: 'Needs decision', needsEscalation: 'Needs escalation', owner: 'Owner', dueDate: 'Due date', status: 'Status', dependency: 'Dependency', basis: 'Basis', likelihood: 'Likelihood', mitigation: 'Mitigation', value: 'Value', recommended: 'Recommended', timing: 'Timing', agenda: 'Agenda' },
  pt: { confidence: 'Confiança', evidenceSufficiency: 'Suficiência das evidências', overallAssessment: 'Avaliação geral', grammar: 'Gramática', vocabulary: 'Vocabulário', fluency: 'Fluência', coherence: 'Coerência', interaction: 'Interação', intelligibility: 'Inteligibilidade', score: 'Nota', observation: 'Observação', whyItMatters: 'Por que importa', pattern: 'Padrão', communicationImpact: 'Impacto na comunicação', nextStep: 'Próximo passo', participation: 'Participação', share: 'Distribuição', interactionPattern: 'Padrão de interação', teacherFeedback: 'Feedback de melhoria', category: 'Categoria', frequency: 'Frequência', impact: 'Impacto', original: 'Original', corrected: 'Correção', explanation: 'Explicação', rule: 'Regra', recurrence: 'Recorrência', priority: 'Prioridade', successfulUse: 'Acertos observados', skill: 'Habilidade', whySuccessful: 'Por que funcionou', selfCorrections: 'Autocorreções', missedOpportunities: 'Oportunidades perdidas', opportunity: 'Oportunidade', coachPrompt: 'Sugestão de prática', reinforce: 'Pontos a consolidar', reason: 'Motivo', nextLessonFocus: 'Foco de melhoria', why: 'Motivo', activities: 'Atividades', successMetric: 'Critério de sucesso', durationMinutes: 'Duração em minutos', basedOn: 'Baseado em', participants: 'Participantes', outcome: 'Resultado', whatChanged: 'O que mudou', needsDecision: 'Precisa de decisão', needsEscalation: 'Precisa escalar', owner: 'Responsável', dueDate: 'Prazo', status: 'Status', dependency: 'Dependência', basis: 'Base', likelihood: 'Probabilidade', mitigation: 'Mitigação', value: 'Valor', recommended: 'Recomendada', timing: 'Momento', agenda: 'Pauta' },
  es: { confidence: 'Confianza', evidenceSufficiency: 'Suficiencia de evidencia', overallAssessment: 'Evaluación general', grammar: 'Gramática', vocabulary: 'Vocabulario', fluency: 'Fluidez', coherence: 'Coherencia', interaction: 'Interacción', intelligibility: 'Inteligibilidad', score: 'Puntuación', observation: 'Observación', whyItMatters: 'Por qué importa', pattern: 'Patrón', communicationImpact: 'Impacto en la comunicación', nextStep: 'Próximo paso', participation: 'Participación', share: 'Distribución', interactionPattern: 'Patrón de interacción', teacherFeedback: 'Feedback de mejora', category: 'Categoría', frequency: 'Frecuencia', impact: 'Impacto', original: 'Original', corrected: 'Corrección', explanation: 'Explicación', rule: 'Regla', recurrence: 'Recurrencia', priority: 'Prioridad', successfulUse: 'Aciertos observados', skill: 'Habilidad', whySuccessful: 'Por qué funcionó', selfCorrections: 'Autocorrecciones', missedOpportunities: 'Oportunidades perdidas', opportunity: 'Oportunidad', coachPrompt: 'Sugerencia de práctica', reinforce: 'Puntos a consolidar', reason: 'Motivo', nextLessonFocus: 'Foco de mejora', why: 'Motivo', activities: 'Actividades', successMetric: 'Criterio de éxito', durationMinutes: 'Duración en minutos', basedOn: 'Basado en', participants: 'Participantes', outcome: 'Resultado', whatChanged: 'Qué cambió', needsDecision: 'Necesita decisión', needsEscalation: 'Necesita escalar', owner: 'Responsable', dueDate: 'Fecha', status: 'Estado', dependency: 'Dependencia', basis: 'Base', likelihood: 'Probabilidad', mitigation: 'Mitigación', value: 'Valor', recommended: 'Recomendada', timing: 'Momento', agenda: 'Agenda' },
};
...
export function createAnalysisPdfDocument({ analysis, recording, locale }: PdfInput): jsPDF {
  ...
  const modeEntries: Array<[string, unknown, Array<[string, string[]]>]> = [
    ...
    ['languageClass', safe.languageClass, [
      ['learnerAssessment', ['learnerProfiles']],
  ...
  modeEntries.forEach(([key, value, groups]) => {
    ...
    if (key === 'languageClass' && isRecord(value.lessonContext)) {
      const executiveBrief = scalarText(value.lessonContext.executiveBrief, language);
      if (executiveBrief) addPanel(copy.executiveBrief, executiveBrief);
    }
