...
test('deterministic checks reject invented action ownership and unselected mode output', () => {
  ...
  const analysis = {
    version: '5.0', analysisModes: ['meeting'], summary: {}, evidenceQuality: {}, interview: { executiveAssessment: { overallScore: 8 } }, languageClass: null,
...
test('deterministic checks accept exact v5 grounded meeting output', () => {
  ...
  const analysis = {
    version: '5.0', analysisModes: ['meeting'], summary: {}, evidenceQuality: {}, interview: null, languageClass: null,
